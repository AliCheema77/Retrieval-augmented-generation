...
def evaluate(test_cases, chunks, metadatas, bm25_index, top_k=3):
    """Run each conversation through the pipeline, checking retrieval rank at every turn."""
    results = []
    ...
    for conversation in test_cases:
        ...
        for turn in conversation:
            ...
            candidates = hybrid_retrieve(standalone_question, chunks, metadatas, bm25_index, top_k=15)
